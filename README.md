...
[![CI](https://img.shields.io/github/actions/workflow/status/KTCrisis/flux7-memory/ci.yaml?style=flat-square&label=CI)](https://github.com/KTCrisis/flux7-memory/actions/workflows/ci.yaml)
